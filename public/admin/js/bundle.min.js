var SelectPure = function () {
    "use strict";
    const e = {value: "data-value", disabled: "data-disabled", class: "class", type: "type"};

    class t {
        constructor(e, t = {}, s = {}) {
            return this._node = e instanceof HTMLElement ? e : document.createElement(e), this._config = {i18n: s}, this._setAttributes(t), t.textContent && this._setTextContent(t.textContent), this
        }
    ...
    return class {
        constructor(e, n) {
            this._config = s({}, n, {classNames: s({}, i, n.classNames)}), this._state = {opened: !1}, this._icons = [], this._boundHandleClick = this._handleClick.bind(this), this._boundUnselectOption = this._unselectOption.bind(this), this._boundSortOptions = this._sortOptions.bind(this), this._body = new t(document.body), this._create(e), this._config.value && this._setValue()
        }
        ...
        _setValue(e, t, s) {
            ...
            this._options.find(e => e.get().getAttribute("data-value") === i.value.toString()).addClass(this._config.classNames.selectedOption), this._placeholder.addClass(this._config.classNames.placeholderHidden), this._selectOption(i, t)
        }
        ...
        _selectOptions(e, s) {
            this._label.setText(""), this._icons = e.map(e => {
                const s = new t("span", {class: this._config.classNames.selectedLabel, textContent: e.label}),
        ...
        _unselectOption(e) {
            const t = [...this._config.value], s = t.indexOf(e.target.getAttribute("data-value"));
            -1 !== s && t.splice(s, 1), this._setValue(t, !0, !0)
        }

        _sortOptions(e) {
            this._options.forEach(t => {
                t.get().textContent.toLowerCase().includes(e.target.value.toLowerCase()) ? t.removeClass(this._config.classNames.optionHidden) : t.addClass(this._config.classNames.optionHidden)
            })
        }
    }
}();
