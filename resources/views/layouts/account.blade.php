...
<html lang="{{app()->getLocale()}}">
    ...
    <head>
        ...
        <script type="text/javascript" src="{{ asset('app/js/materialize.min.js') }}" defer></script>
        ...
        <!-- Fonts -->
        <link
            href="https://fonts.googleapis.com/css?family=Roboto+Slab:300,400|Roboto:400,500,500i,700&display=swap&subset=cyrillic-ext"
            rel="stylesheet">
    ...
    <body>
        <div class="wrapper">
            ...
            @include('account.components.header')
            <main>
                @yield('main')
            </main>
            @include('account.components.footer')
        </div>
    </body>
